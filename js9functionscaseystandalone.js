...
function drawCall() {
	...
	MathJax.Hub.Typeset();
        ...
        function generateSecondMathElements() {
            ...
            expanding ever since. The slope of the line made from the distances and speeds of the supernova you worked with in the previous section can be used to estimate the age of the universe:
            <p>\`
            ...
            ${finalAge.toExponential(3).toString().replace("e+", "*10^")}
             ...
             ${" "} years
             <br/><br/>
             <p id="correctAnswer" style="display: none">Correct - the age of the universe is measured in billions of years. Currently, the best values of the Hubble constant range from 67 to 74 km/sec/Mpc, which implies the age of the Universe is between 13.2 and 14.6 billion years.</p>
             <p id="incorrectAnswer" style="display: none">Incorrect - the age of the universe is measured in billions of years. Currently, the best values of the Hubble constant range from 67 to 74 km/sec/Mpc, which implies the age of the Universe is between 13.2 and 14.6 billion years.</p>
             </p>
